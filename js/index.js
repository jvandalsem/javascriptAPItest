var nytimesKey = 'DkTiN2bcJXWmD96LFhBk9WMTL27j8EPG';
var googleBooksKey = 'AIzaSyD-OO52M2Pjyr1mSdyypQT9wtp-TKtYPZE';
  ...
  nytimesBestSellers.results.forEach(function(book) {
    ...
    var listing =
        '<div id="' + book.rank + '" class="entry">' +
          ...
          '</p>' +
          '<h2><a href="' + book.amazon_product_url + '" target="_blank">' + bookInfo.title + '<i class="fab fa-amazon" aria-hidden="true"></i>' + '</a></h2>' +
